...
function purchase_admin(userid,order_id,email,status,action,street,city,payment){
    return new Promise(resolve=>{
        ...
        },{$push:{'orders.$.buyer':{email:email,Address:{street:street,city:city},Status:status,Action:action,Payment:payment}}}).exec()
